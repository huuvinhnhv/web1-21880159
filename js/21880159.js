...
async function login(e) {
  ...
  document.getElementById("error-login-message").innerHTML = '';
  try {
    ...
    document.getElementById("error-login-message").innerHTML = error;
    displayControls(false);
  }
}

function displayControls(isLogin = true) {
  let linkLogins = document.getElementsByClassName('link-login');
  let linkLogouts = document.getElementsByClassName('link-logout');
